package com.zpedroo.gems.utils;
...
public class FileUtils {
    ...
    public class FileManager {
        ...
        public FileManager(Files file) {
            this.pdfile = new File(gems.getDataFolder() + (file.getFolder().isEmpty() ? "" : "/" + file.getFolder()), file.getName());

            if (!pdfile.exists()) {
                if (file.requireEmpty) {
                    File folder = new File(gems.getDataFolder(), "/categories");
                ...
                try {
                    ...
                    copy(gems.getResource((file.getResource().isEmpty() ? "" : file.getResource() + "/") + file.getName()), pdfile);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
